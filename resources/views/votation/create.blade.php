                ...
                <div class="p-6 bg-white border-b border-gray-200 mt-4">
                    <form method="POST" action="{{ route('votation.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-input id="opening_at" class="block mt-1 w-full" type="datetime-local" name="opening_at" :value="old('opening_at')" required />
                        </div>

                        <div class="mt-4">
                            <x-label for="closing_at" :value="__('Encerramento às')" />
                            <x-input id="closing_at" class="block mt-1 w-full" type="datetime-local" name="closing_at" :value="old('closing_at')" required />
                        </div>
